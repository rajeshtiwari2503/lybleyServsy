...
const HomeSolution = () => {
  return (
    <div className='pt-14 pb-12 md:pt-10'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-8 md:px-24 mt-14">
          <div className='flex flex-col text-center p-2 md:p-0 shadow-md md:shadow-none rounded-md items-center'>
